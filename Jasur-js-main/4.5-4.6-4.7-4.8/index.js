...
// const names = people.map((person) => person.name.split(', ').join(", "));
// console.log(names);
...
// const userOlderThan30 = users.filter((person) => person.age > 30);
// console.log(userOlderThan30);



// const userHasVue = users.find((user) => user.skills.includes("Vue"));
// const userHasVue = users.filter((user) => user.skills.includes("Vue"));
