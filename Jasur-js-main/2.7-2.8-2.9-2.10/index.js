...
// let str2 = "My name is Alexei";
// console.log(str2.toUpperCase());


// let userName = 'Alexei'
// let str = `My name is ${userName}`;
// console.log(userName.indexOf('ei')); // 4
// console.log(str.indexOf('ei')); // 15
// console.log(str.indexOf('asd')); // -1
...
// console.log(str.toLocaleLowerCase().indexOf('al')); // 11
...
// console.log(
//     `The string "${userName}" ${str.includes(userName) ? 'is' : 'is not'} in the sentence`
// );
...
// const lastElement1 = array1.pop();
// const lastElement2 = array1.push(7);
// console.log(lastElement1); // 2 
// console.log(lastElement2); //  length = 6
// console.log(array1.length); // 6
// console.log(array1);  // [1, 2, 3, 4, 3, 7]



// const array = [10, 20, 30, 40, 30, 50, 10];
...
// const hasElement = array.includes(3, 2); //true
// const hasElement = array.includes(3, 3); //false
...
// const removedElements = array.slice(2);
// console.log(removedElements);
// console.log(array);
...
// ];
// console.log(students[1]); // ["сергей лобанов", 4, 521401]
// console.log(students[1][2]); // 521401




// const students = [
//     ["сергей лобанов1", 3, 521301],
//     ["сергей лобанов2", 4, 521401],
//     ["сергей лобанов3", 2, 521201],
//     ["сергей лобанов4", 1, 521101],
// ];
