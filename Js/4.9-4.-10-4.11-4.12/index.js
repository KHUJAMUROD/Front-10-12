...
// const {params: { height: heightPerson, weight: weightPerson}, 
// } = person;

// console.log(heightPerson, weightPerson);
...
// const {  isMarried, hobbies: [, , lastHobby],} = person;
...
// const {age = 0,  params: { weight = "no data"  } ={}, hobbies: [firstHobby = "no data"] = [], } = person || {};
