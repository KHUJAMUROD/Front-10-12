...
// const listNumbers = [0.1, 100, 10, 2, 23, 5,];
...
// listUsers.sort((a, b) => a.age - b.age);
...
// const jsTopics = tasks.filter((topic) => topic.toLowerCase().includes("javascript"));
...
//     {id : 2, description: 'Сделать уроки', completed: false,},
