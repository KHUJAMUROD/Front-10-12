...
// console.log(book[1].pageCount); // 33
...
//     },
//     business: {
//         title: "Банкроство или кредитное рабство?",
//         writers: ["Роман Цветков", "Ибрагим Мамедов", "Владимир Левин",],
//     },
//     health:{
//         title: "Жиросжигатель из сладкого?",
//         writers: ["Ирина Волан", "Екатерина Заостровцева", "Тимур Голаев"],
//     } ,
...
//     }
// });
// console.log(Object.entries(transFormNewsPaper));
...
try {
    ...
    textResult.innerHTML = parseInt(calc(num1, num2))
} catch (error) {
